...
from backend import record_time, check_direct, template_params, check_existing, get_end_step, Graph, \
...
class Simulation(ABC):
    ...
    def add_agents(self, number, agent_type=None):
        ...
        for array_name in self.array_names:
            ...
            if array_name == "locations":
                array = np.random.rand(number, self.dimension) * self.size
    ...
    def full_setup(self):
        ...
        self.locations = self.agent_array(vector=self.dimension)
